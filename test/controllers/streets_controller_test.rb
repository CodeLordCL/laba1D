...
class StreetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create street" do
    assert_difference('Street.count') do
      post streets_url, params: { street: { building_count: @street.building_count, city_id: @street.city_id, name: @street.name } }
    end
  ...
  test "should update street" do
    patch street_url(@street), params: { street: { building_count: @street.building_count, city_id: @street.city_id, name: @street.name } }
